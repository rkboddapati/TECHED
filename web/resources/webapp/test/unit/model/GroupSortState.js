sap.ui.define([
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("PURCHASEORDERID").length, 1, "The sorting by PURCHASEORDERID returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by PURCHASEORDERID and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "GROSSAMOUNT");

		this.oGroupSortState.sort("PURCHASEORDERID");
