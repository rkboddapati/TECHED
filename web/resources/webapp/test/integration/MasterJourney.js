sap.ui.define([
		...
		opaTest("MasterList Filtering on GROSSAMOUNT less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("GROSSAMOUNT").
		...
		opaTest("MasterList Filtering on GROSSAMOUNT more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 ").
				and.iPressOKInViewSelectionDialog();
