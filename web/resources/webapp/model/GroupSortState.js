sap.ui.define([
	...
	return BaseObject.extend("dummy.model.GroupSortState", {
		 ...
		 * @alias dummy.model.GroupSortState
		 */
		...
		/**
		 * Sorts by PURCHASEORDERID, or by GROSSAMOUNT
		 *
		...
		group: function (sKey) {
			...
			if (sKey === "GROSSAMOUNT") {
				...
				this._oViewModel.setProperty("/sortBy", "PURCHASEORDERID");
			}
